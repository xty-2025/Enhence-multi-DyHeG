...
if __name__ == "__main__":
    ...
    parser.add_argument('--total_graph_name', type=str, nargs='?',
                        default='/root/XZZDynHHH/data/beauty/total_graphs.pkl',
                        help='total graph name')
    parser.add_argument('--context_pairs_path', type=str, nargs='?',
                        default='/root/XZZDynHHH/data/beauty/context_pairs.pkl',
                        help='The path of context_pairs')
    parser.add_argument('--datapath', type=str, nargs='?', default='/root/XZZDynHHH/data/beauty',
                        help='datapath')
